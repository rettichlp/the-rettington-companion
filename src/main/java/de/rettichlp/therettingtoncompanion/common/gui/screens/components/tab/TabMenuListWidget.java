...
@Environment(CLIENT)
public class TabMenuListWidget extends TabMenuWidget {

    public TabMenuListWidget(int width, int height, int x, int y) {
    ...
    public void renderWidget(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        context.drawVerticalLine(getX(), getY(), getY() + getHeight(), Color.GREEN.getRGB());
        context.drawVerticalLine(getX() + getWidth(), getY(), getY() + getHeight(), Color.GREEN.getRGB());
    }
}
