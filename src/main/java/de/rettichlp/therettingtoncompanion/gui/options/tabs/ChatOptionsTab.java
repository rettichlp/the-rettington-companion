...
public class ChatOptionsTab extends AbstractTRCOptionsTab {
    ...
    public void populateOptionsList(@NonNull TRCOptionsList optionsList) {
        ...
        optionsList.addFullWidthSlider(translatable("trc.option.chat.general.max_messages.label"), create(translatable("trc.option.chat.general.max_messages.tooltip")), 0, 10_000, 1_000, configuration.chat().getMaxChatMessages(), configuration.chat()::setMaxChatMessages);
